...
for (const u of users) {
  sql +=
    `INSERT INTO users (` +
    `user_identifier, name, name_kana, birth_date, gender, email, mbti_code, joined_at, retired_at, final_education, status, affiliation, avatar_path, github_url, pr_text, specialty, tech_strength, sales_comment, toeic_score, other_skills` +
    `) VALUES (` +
    [
